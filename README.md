...
**Want the full map?** [`docs/SYSTEM_WALKTHROUGH.MD`](docs/SYSTEM_WALKTHROUGH.MD) · **Canonical target architecture (APEX):** [`docs/CANONICAL_SPEC_INDEX.MD`](docs/CANONICAL_SPEC_INDEX.MD) · **Code ↔ APEX domains:** [`docs/CANONICAL_MODULE_MAP.MD`](docs/CANONICAL_MODULE_MAP.MD) · **Release gating / experiment registry:** [`docs/GOVERNANCE_RELEASE_AND_EXPERIMENTS.MD`](docs/GOVERNANCE_RELEASE_AND_EXPERIMENTS.MD) · **Repo contract for contributors:** [`AGENTS.md`](AGENTS.md).
