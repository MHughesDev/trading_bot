...
ROWS: list[dict[str, str]] = [
    {
        ...
        "docs_refs": "docs/operations/ready_to_run.md",
        "audit_id": "",
        "anchor": "",
    },
    {
    ...
    },
    {
        ...
        "docs_refs": "README.md|docs/operations/ready_to_run.md|docs/operations/windows_operator_ui.md",
        "audit_id": "",
        "anchor": "",
    },
    {
        ...
        "docs_refs": "README.md|docs/operations/ready_to_run.md",
        "audit_id": "",
        "anchor": "",
    },
    {
        ...
        "affected_files": "README.md|docs/operations/ready_to_run.md|docs/operations/windows_operator_ui.md|docs/operations/runbooks.md|docs/QUEUE.MD|docs/QUEUE_ARCHIVE.MD",
        "audit_id": "",
        "anchor": "",
    },
    {
        ...
        "docs_refs": "docs/operations/runbooks.md",
        "audit_id": "",
        "anchor": "",
    },
    {
        ...
        "docs_refs": "README.md|docs/operations/runbooks.md",
        "audit_id": "",
        "anchor": "",
    },
    {
    ...
    },
    {
        ...
        "affected_files": "README.md|docs/operations/runbooks.md",
        "docs_refs": "docs/operations/per_asset_operator.md|.env.example",
        "audit_id": "",
    ...
    },
    {
        ...
        "affected_files": "README.md|docs/operations/runbooks.md",
        "docs_refs": "docs/governance/audit_code_review.md",
        "audit_id": "DOC-A1",
    ...
    },
    {
        ...
        "affected_files": "README.md|docs/operations/runbooks.md|control_plane/streamlit_util.py",
        "docs_refs": "docs/governance/audit_code_review.md",
        "audit_id": "DOC-A2",
        "anchor": "#25-post-audit-hardening-fb-aud",
    },
    {
        ...
        "agent_task": "COMPLETED. Pin aquasecurity/trivy-action to v0.35.0 in .github/workflows/ci.yml (upstream tag migration / supply-chain remediation). Traceability: docs/governance/ci_root_cause_analysis_prompt.md.",
        "affected_files": ".github/workflows/ci.yml",
        "docs_refs": "docs/governance/ci_root_cause_analysis_prompt.md",
        "audit_id": "",
        "anchor": "",
    },
    {
        ...
        "affected_files": "control_plane/api.py|docs/operations/runbooks.md",
        "docs_refs": "docs/governance/audit_code_review.md|docs/operations/runbooks.md",
        "audit_id": "OPS-A1",
        "anchor": "#25-post-audit-hardening-fb-aud",
    },
    {
        ...
        "affected_files": "control_plane/api.py|docs/operations/runbooks.md|infra/",
        "docs_refs": "docs/governance/audit_code_review.md",
        "audit_id": "OPS-A2",
        "anchor": "#25-post-audit-hardening-fb-aud",
    },
    ...
    },
    {
        ...
        "affected_files": "README.md|docs/operations/runbooks.md|.env.example",
        "docs_refs": "docs/governance/audit_code_review.md",
        "audit_id": "SEC-A2",
        "anchor": "#25-post-audit-hardening-fb-aud",
    },
    ...
    },
    {
        ...
        "affected_files": "docs/operations/runbooks.md",
        "docs_refs": "docs/governance/audit_code_review.md",
        "audit_id": "DEBT-A1",
        "anchor": "#25-post-audit-hardening-fb-aud",
    },
    {
        ...
        "docs_refs": "docs/governance/audit_code_review.md|docs/Specs/OBSERVABILITY_AND_INFRA.MD",
        "audit_id": "DATA-A1",
        "anchor": "#25-post-audit-hardening-fb-aud",
    },
    {
        ...
        "affected_files": "docs/operations/runbooks.md",
        "docs_refs": "docs/governance/audit_code_review.md|AGENTS.md",
        "audit_id": "MT-A1",
        "anchor": "#25-post-audit-hardening-fb-aud",
    },
    {
    ...
    },
    {
        ...
        "affected_files": "scripts/ci_pip_audit.sh|.github/workflows/ci.yml|pyproject.toml|README.md|docs/operations/runbooks.md",
    ...
    },
    {
        ...
        "affected_files": ".github/workflows/ci.yml|AGENTS.md|docs/operations/runbooks.md",
        "docs_refs": "docs/reports/AUDIT_REPORT_2026-04-13_full.md",
    ...
    },
    {
        ...
        "agent_task": "COMPLETED. Published docs/reports/REPO_VS_CANONICAL_SPECS_GAP_AUDIT.md with runtime/config/docs/tests inventory, canonical domain-by-domain gaps, exact delete/create/refactor targets, migration risks, ordered implementation sequence, and queue ID mapping for FB-CAN-001..014.",
    ...
    },
    {
        ...
        "agent_task": "Make docs/Human Provided Specs/new_specs/canonical the declared source of truth in README/docs. Replace or mark docs/Specs/*.MD and docs/Human Provided Specs/* files that conflict with canonical specs as superseded/non-canonical, and add a canonical index page with explicit precedence rules. Keep historical docs but prevent them from being interpreted as active architecture requirements.",
    ...
    },
    {
        ...
        "agent_task": "Replace current AppSettings/default.yaml shape with canonical configuration domains (signal confidence, state/degradation, regime, trigger, auction, risk/sizing, execution, carry, monitoring, replay, feature-family flags, metadata/versioning). Add explicit versioned config objects and compatibility/migration handling so runtime and replay both bind to immutable config versions.",
    ...
    },
    {
        ...
        "agent_task": "Implement a dedicated state/regime module producing trend/range/stress/dislocated/transition probabilities, regime confidence, transition probability, novelty, heat, reflexivity, and degradation state outputs required by canonical specs. Wire outputs into decision flow and risk/execution consumers; remove reliance on legacy semantic mapping that only mirrors ForecastPacket regime vector.",
    ...
    },
    {
        ...
        "agent_task": "Add Setup → Pre-Trigger → Confirmed Trigger logic with deterministic formulas, confidence thresholds, suppression/missed-move rules, and explicit trigger records. Integrate trigger outcomes into candidate generation and ensure replay emits identical trigger-stage events.",
    ...
    },
    {
        ...
        "agent_task": "Create candidate auction layer that scores eligible trades using canonical positive/negative terms, applies diversification/overlap/edge-budget penalties, enforces throttles/top-N selection, and emits explainable accept/reject reasons. Replace direct single-proposal policy pass-through with ranked candidate selection.",
    ...
    },
    {
        ...
        "agent_task": "Rebuild risk_engine to support canonical sizing and constraints: degradation multipliers, position inertia, concentration/thesis limits, edge budgeting, capped asymmetry boost, and liquidation offense/defense logic while preserving hard safety overrides. Remove obsolete logic branches that only support legacy proposal semantics.",
    ...
    },
    {
        ...
        "agent_task": "Extend execution domain to include execution confidence scoring, style recommendation (passive/aggressive/staggered/twap), stress posture, worst-case edge checks, partial-fill reconciliation, and execution feedback loops. Preserve adapter routing and intent signing gates, but replace thin submit-only behavior in service abstractions.",
    ...
    },
    {
        ...
        "agent_task": "Refactor backtesting/replay interfaces to canonical replay run contract and event families, including deterministic mode, stress/fault-injected profiles, and live-vs-shadow comparison outputs. Ensure replay includes trigger/auction/execution/risk events and config+logic version fidelity.",
    ...
    },
    {
        ...
        "agent_task": "Add monitoring/alerting coverage for canonical domains: data quality, state/regime/degradation, trigger health, auction quality, risk, execution quality, carry sleeve, drift/calibration, replay-shadow divergence, and governance/operator signals. Update metrics, dashboards, and alert documentation to match canonical definitions.",
    ...
    },
    {
        ...
        "docs_refs": "docs/reports/REPO_VS_CANONICAL_SPECS_GAP_AUDIT.md|docs/architecture/risk_precedence.md",
    ...
    },
    {
        ...
        "agent_task": "Implement thesis-aware concentration controls linking candidate thesis clusters and existing portfolio exposure. Enforce overlap caps and offense/defense posture adjustments when liquidation or stress structure dominates.",
    ...
    },
    {
        ...
        "agent_task": "Implement canonical execution style selector with deterministic thresholds for passive/aggressive/staggered/twap, urgency handling, and remaining-edge checks. Emit style choice + rationale in execution decision records.",
    ...
    },
    {
        ...
        "agent_task": "Implement canonical partial-fill reconciliation including residual quantity handling, cancel/replace policy, residual edge checks, and feedback events. Ensure replay simulator models partial-fill outcomes with same logic interface.",
    ...
    },
    {
        ...
        "docs_refs": "docs/Human Provided Specs/new_specs/canonical/APEX_Config_Management_and_Release_Gating_Spec_v1_0.md|docs/operations/runbooks.md",
