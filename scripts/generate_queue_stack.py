...
ROWS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "agent_task": "Create docs/reports/REPO_VS_CANONICAL_SPECS_GAP_AUDIT.md as the authoritative repo-vs-canonical audit. Include runtime entrypoints, architecture inventory, config surface inventory, docs/spec inventory, tests/CI assumptions, and domain-by-domain gaps against docs/Human Provided Specs/new_specs/canonical/*.md. Must enumerate exact delete/create/refactor targets, migration risks, ordered implementation plan, and mapping from queue IDs FB-CAN-001..014 to domains.",
