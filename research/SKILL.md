...
6. Mark closed OQs as `Closed (see C-XXX)`.
7. Re-scan both files for:
...
8. Commit only the relevant research files unless the user asked for broader changes.
