...
from legacy.decision_pipeline.forecaster_model.calibration.conformal import MultiHorizonConformal, load_conformal_state
...
def build_forecast_packet_methodology(
    ...
    *,
    ...
    if torch_model is not None and torch_device is not None:
        from legacy.decision_pipeline.forecaster_model.inference.torch_infer import forward_torch_quantiles
