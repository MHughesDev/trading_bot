...
1. **Rewriting the entire backend in Rust**, following the architecture in [`../spec/`](../spec/).
...
[`../file-structure.md`](../file-structure.md). That document is the **structural contract**; this
...
The sequence mirrors [`../spec/11-roadmap.md`](../spec/11-roadmap.md), with a **documentation phase
...
**Decision gates that block code (from [`../spec/10-open-questions.md`](../spec/10-open-questions.md)).**
...
3. **Execute the phase plans from `refactor_reference_docs/plans/`** — these files. They are the
   canonical, self-contained, executable plans. Each references the stable spec at
   [`../spec/`](../spec/) and the structure at [`../file-structure.md`](../file-structure.md), both of
...
- [`refactor_reference_docs/plans/`](.) (these files) = the **canonical executable plans**. Read and
...
**Canonical content reference:** Until Phase A runs, [`../spec/`](../spec/) and
[`../file-structure.md`](../file-structure.md) are the only spec/structure docs. After Phase A,
`docs/specs/` and `docs/architecture.md` are the *restructured* canonical versions for the
documentation record — but the phase files keep citing `../spec/`/`../file-structure.md` (which still
