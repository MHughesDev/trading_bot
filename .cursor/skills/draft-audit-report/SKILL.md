...
description: Turn raw full-audit outputs into a polished standalone audit report matching docs/governance/full_audit.md §8 and docs/reports/AUDIT_REPORT_TEMPLATE.md. Use after running a full or partial audit per full_audit.md.
---

# Draft audit report

**Purpose:** Produce a **high-quality, standalone** audit report that mirrors **[`docs/governance/full_audit.md`](../../../docs/governance/full_audit.md) §8** and **[`docs/reports/AUDIT_REPORT_TEMPLATE.md`](../../../docs/reports/AUDIT_REPORT_TEMPLATE.md)**.
...
2. **Sections** — strictly follow **[§8.2](../../../docs/governance/full_audit.md#82-required-sections-in-order)** in `full_audit.md`:  
...
6. **Cross-link** to [`full_audit.md`](../../../docs/governance/full_audit.md) and the audited commit in **Metadata**.
...
- [`docs/governance/full_audit.md`](../../../docs/governance/full_audit.md) — **§8** deliverable spec  
