...
## Operator readiness (FB-DASH-01-02)

Before paper or live operation, follow **[`OPERATOR_READY_CHECKLIST.MD`](OPERATOR_READY_CHECKLIST.MD)** (venv, `pip install`, `.env`, optional Docker, preflight, venue keys vs `execution_mode`). This runbook expands secrets, incident, and restart behavior; the checklist is the single numbered entry point.
