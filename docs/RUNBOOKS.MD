...
## Multi-symbol portfolio limits (FB-SPEC-07 — documented)
...
- **Stretch (still open in backlog):** cross-symbol capital allocation, correlation-aware sizing, or formal risk-parity — requires `risk_engine/` / `decision_engine/` work beyond this documentation pass.
