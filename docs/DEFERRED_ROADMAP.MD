...
**Queue:** Parent rows **FB-N1** / **FB-N3** in [`QUEUE.MD`](QUEUE.MD) are **Done** (**closed for now**, 2026-04-17); sub-slices **FB-N1-S1** / **FB-N3-S1** remain the delivered first steps. This file still describes **future** work if you **reopen** or add new backlog items.
