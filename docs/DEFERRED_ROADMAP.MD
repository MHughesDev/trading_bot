...
Items in [`QUEUE.MD`](QUEUE.MD) **§2.1** are **intentionally out of scope** for the current V1 trading stack. This file records **recommended next steps** when you promote them.
